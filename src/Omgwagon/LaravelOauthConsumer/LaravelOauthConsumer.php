...
class LaravelOauthConsumer {
     ...
     * @return LaravelOauthConsumer (Object)
     */
    public function setup($APIKey = "", $sharedSecret = "") {
        if (!empty($APIKey)) {
    ...
    public function sign_params( $params, $url ) {
        ...
        $this->setUrl( preg_replace( '/:80|:443/', '', $parse_url['scheme'] . '://' . $parse_url['host'] . $port . $path_part ) );
